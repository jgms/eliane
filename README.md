...
If you want to see some code examples you can go [here](https://github.com/jgms/construye-un-castillo), and if you just want to listen to said examples, you can go [here](https://soundcloud.com/construye-un-castillo/sets/cuaderno-de-apuntes).
